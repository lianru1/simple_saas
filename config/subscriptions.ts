...
export const CREDITS_TIERS: ProductTier[] = [
  {
    name: "Basic Package",
    id: "tier-3-credits",
    productId: "prod_1CXEdOeeXW3ZyjuClUQZWH", // $9 one-time purchase
    priceMonthly: "$9",
  ...
  },
  {
    ...
    id: "tier-6-credits",
    productId: "prod_1CXEdOeeXW3ZyjuClUQZWH", // $13 one-time purchase
    priceMonthly: "$13",
  ...
  },
  {
    ...
    id: "tier-9-credits",
    productId: "prod_1CXEdOeeXW3ZyjuClUQZWH", // $29 one-time purchase
    priceMonthly: "$29",
